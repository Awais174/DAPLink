...
#define USBD_MAX_PACKET0            8 //reduce EP0 bMaxPacketSize0 on the Device Descriptor from 0x40 (64) to 0x08 (minimum) to support multiple VCOM ports
#else
...
#else
#define USBD_CDC_ACM_CIF_STRDESC        L"mbed Serial Port1"
#define USBD_CDC_ACM_DIF_STRDESC        L"mbed Serial Port1"
#if (ENABLE_2ND_COM_PORT)
#define USBD_CDC_2_ACM_CIF_STRDESC        L"mbed Serial Port2"
#define USBD_CDC_2_ACM_DIF_STRDESC        L"mbed Serial Port2"
#endif 
#if (ENABLE_3RD_COM_PORT)
#define USBD_CDC_3_ACM_CIF_STRDESC        L"mbed Serial Port3"
#define USBD_CDC_3_ACM_DIF_STRDESC        L"mbed Serial Port3"
#endif 
#endif 
#define USBD_CDC_ACM_SENDBUF_SIZE       64
#define USBD_CDC_ACM_RECEIVEBUF_SIZE    64
#if ENABLE_2ND_COM_PORT
#define USBD_CDC_2_ACM_SENDBUF_SIZE     64
#define USBD_CDC_2_ACM_RECEIVEBUF_SIZE  64
#endif
#if ENABLE_3RD_COM_PORT
#define USBD_CDC_3_ACM_SENDBUF_SIZE     64
#define USBD_CDC_3_ACM_RECEIVEBUF_SIZE  64
#endif 
...
#if (ENABLE_2ND_COM_PORT)
#define USBD_CDC_2_ACM_EP_INTIN             5 
#define USBD_CDC_2_ACM_EP_BULKIN            6 
#define USBD_CDC_2_ACM_EP_BULKOUT           6 
#endif 
#if (ENABLE_3RD_COM_PORT)
#define USBD_CDC_3_ACM_EP_INTIN             7 
#define USBD_CDC_3_ACM_EP_BULKIN            8 
#define USBD_CDC_3_ACM_EP_BULKOUT           8
#endif
...
#define USBD_IF_NUM                (USBD_HID_ENABLE+USBD_MSC_ENABLE+(USBD_ADC_ENABLE*2)+(USBD_CDC_ACM_ENABLE*4)+USBD_CLS_ENABLE)
#elif (ENABLE_3RD_COM_PORT && ENABLE_2ND_COM_PORT)  
#define USBD_IF_NUM                (USBD_HID_ENABLE+USBD_MSC_ENABLE+(USBD_ADC_ENABLE*2)+(USBD_CDC_ACM_ENABLE*6)+USBD_CLS_ENABLE)
#else
...
#elif (ENABLE_2ND_COM_PORT && !ENABLE_3RD_COM_PORT)
#define USBD_EP_NUM_CALC2           MAX((USBD_ADC_ENABLE    *(USBD_ADC_EP_ISOOUT    )), (USBD_CDC_ACM_ENABLE*(USBD_CDC_2_ACM_EP_INTIN)))
#define USBD_EP_NUM_CALC3           MAX((USBD_CDC_ACM_ENABLE*(USBD_CDC_2_ACM_EP_BULKIN)), (USBD_CDC_ACM_ENABLE*(USBD_CDC_2_ACM_EP_BULKOUT)))
#elif (ENABLE_3RD_COM_PORT && ENABLE_2ND_COM_PORT) 
#define USBD_EP_NUM_CALC2           MAX((USBD_ADC_ENABLE    *(USBD_ADC_EP_ISOOUT    )), (USBD_CDC_ACM_ENABLE*(USBD_CDC_3_ACM_EP_INTIN)))
#define USBD_EP_NUM_CALC3           MAX((USBD_CDC_ACM_ENABLE*(USBD_CDC_3_ACM_EP_BULKIN)), (USBD_CDC_ACM_ENABLE*(USBD_CDC_3_ACM_EP_BULKOUT)))
#else
#error "Wrong pre-processor macros defined for multiple COM ports"
#endif
...
#if (ENABLE_2ND_COM_PORT)
#if  (((USBD_HID_EP_INTIN   == USBD_CDC_2_ACM_EP_INTIN)   || \
			 (USBD_HID_EP_INTIN   == USBD_CDC_2_ACM_EP_BULKIN)  || \
			 (USBD_HID_EP_INTIN   == USBD_CDC_2_ACM_EP_BULKOUT))|| \
			((USBD_HID_EP_INTOUT  != 0)                       && \
			((USBD_HID_EP_INTOUT  == USBD_CDC_2_ACM_EP_INTIN)   || \
			 (USBD_HID_EP_INTOUT  == USBD_CDC_2_ACM_EP_BULKIN)  || \
			 (USBD_HID_EP_INTOUT  == USBD_CDC_2_ACM_EP_BULKOUT)))) 
#error "HID and Communication Device Interface-2 can not use same Endpoints!"
#endif
#endif 
#if (ENABLE_3RD_COM_PORT)
#if  (((USBD_HID_EP_INTIN   == USBD_CDC_3_ACM_EP_INTIN)   || \
			 (USBD_HID_EP_INTIN   == USBD_CDC_3_ACM_EP_BULKIN)  || \
			 (USBD_HID_EP_INTIN   == USBD_CDC_3_ACM_EP_BULKOUT))|| \
			((USBD_HID_EP_INTOUT  != 0)                       && \
			((USBD_HID_EP_INTOUT  == USBD_CDC_3_ACM_EP_INTIN)   || \
			 (USBD_HID_EP_INTOUT  == USBD_CDC_3_ACM_EP_BULKIN)  || \
			 (USBD_HID_EP_INTOUT  == USBD_CDC_3_ACM_EP_BULKOUT)))) 
...
#endif
#if ENABLE_2ND_COM_PORT
#if   ((USBD_MSC_EP_BULKIN  == USBD_CDC_2_ACM_EP_INTIN)   || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_2_ACM_EP_BULKIN)  || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_2_ACM_EP_BULKOUT) || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_2_ACM_EP_INTIN)   || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_2_ACM_EP_BULKIN)  || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_2_ACM_EP_BULKOUT))
#error "Mass Storage Device and Communication Device Interface-2 can not use same Endpoints!"
#endif
#endif 
#if ENABLE_3RD_COM_PORT
#if   ((USBD_MSC_EP_BULKIN  == USBD_CDC_3_ACM_EP_INTIN)   || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_3_ACM_EP_BULKIN)  || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_3_ACM_EP_BULKOUT) || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_3_ACM_EP_INTIN)   || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_3_ACM_EP_BULKIN)  || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_3_ACM_EP_BULKOUT))
...
#elif (ENABLE_2ND_COM_PORT && !ENABLE_3RD_COM_PORT)
#define USBD_CDC_2_ACM_CIF_NUM     (USBD_CDC_ACM_DIF_NUM+1)
#define USBD_CDC_2_ACM_DIF_NUM     (USBD_CDC_2_ACM_CIF_NUM+1)
#define USBD_HID_IF_NUM            (USBD_CDC_2_ACM_DIF_NUM+1)
#elif (ENABLE_3RD_COM_PORT && ENABLE_2ND_COM_PORT)  
#define USBD_CDC_2_ACM_CIF_NUM     (USBD_CDC_ACM_DIF_NUM+1)
#define USBD_CDC_2_ACM_DIF_NUM     (USBD_CDC_2_ACM_CIF_NUM+1)
#define USBD_CDC_3_ACM_CIF_NUM     (USBD_CDC_2_ACM_DIF_NUM+1)
#define USBD_CDC_3_ACM_DIF_NUM     (USBD_CDC_3_ACM_CIF_NUM+1)
#define USBD_HID_IF_NUM            (USBD_CDC_3_ACM_DIF_NUM+1)
#else
#error "Wrong pre-processor macros defined for multiple COM ports"
#endif 
...
#elif (ENABLE_2ND_COM_PORT && !ENABLE_3RD_COM_PORT)
#define USBD_CDC_2_ACM_CIF_STR_NUM   (USBD_CDC_ACM_DIF_STR_NUM+1)
#define USBD_CDC_2_ACM_DIF_STR_NUM   (USBD_CDC_2_ACM_CIF_STR_NUM+1)
#define USBD_HID_IF_STR_NUM        (USBD_CDC_2_ACM_DIF_STR_NUM+1)
#define USBD_MSC_IF_STR_NUM        (USBD_HID_IF_STR_NUM+1)
#elif (ENABLE_3RD_COM_PORT && ENABLE_2ND_COM_PORT)  
#define USBD_CDC_2_ACM_CIF_STR_NUM   (USBD_CDC_ACM_DIF_STR_NUM+1)
#define USBD_CDC_2_ACM_DIF_STR_NUM   (USBD_CDC_2_ACM_CIF_STR_NUM+1)
#define USBD_CDC_3_ACM_CIF_STR_NUM   (USBD_CDC_2_ACM_DIF_STR_NUM+1)
#define USBD_CDC_3_ACM_DIF_STR_NUM   (USBD_CDC_3_ACM_CIF_STR_NUM+1)
#define USBD_HID_IF_STR_NUM        (USBD_CDC_3_ACM_DIF_STR_NUM+1)
#define USBD_MSC_IF_STR_NUM        (USBD_HID_IF_STR_NUM+1)
#else
#error "Wrong pre-processor macros defined for multiple COM ports"
#endif 
